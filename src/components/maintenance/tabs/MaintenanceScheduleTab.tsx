      ...
      <div className="h-full flex flex-col">
        <div className="flex-shrink-0 px-4 py-6">
          ...
          <Tabs value={activeTab} onValueChange={setActiveTab} className="h-full flex flex-col">
            ...
            <TabsContent value="queue" className="flex-1 relative overflow-hidden mt-0">
            ...
            <TabsContent value="overview" className="flex-1 relative overflow-hidden mt-0">
              <div className="h-full flex flex-col">
            ...
            <TabsContent value="unitturns" className="flex-1 relative overflow-hidden mt-0">
              <div className="h-full">
                <UnitTurnTracker onSelectUnitTurn={setSelectedUnitTurn} />
                <ScheduleDropZone onScheduleWorkOrder={handleScheduleWorkOrder} />
              </div>
