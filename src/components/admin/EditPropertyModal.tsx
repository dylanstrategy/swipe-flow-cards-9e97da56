  ...
  useEffect(() => {
    if (property && isOpen) {
      setFormData({
        ...
        guest_policy: property.guest_policy || '',
        ...
        wifi_management_vendor: property.wifi_management_vendor || '',
        inspection_required: property.inspection_required ?? true,
        concierge_available: property.concierge_available ?? false
      });
    }
  }, [property, isOpen]);
    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-4xl max-h-[80vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-4">
            <h3 className="text-lg font-semibold border-b pb-2">Operational Settings</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="flex items-center space-x-2">
                ...
                />
                <Label htmlFor="inspection_required">Inspection Required for Move-ins</Label>
              </div>
              <div className="flex items-center space-x-2">
                <Switch
                  id="concierge_available"
                  checked={formData.concierge_available}
                  onCheckedChange={(checked) => handleInputChange('concierge_available', checked)}
                />
                <Label htmlFor="concierge_available">Concierge Available</Label>
              </div>
            </div>
          ...
          {/* Maintenance & Vendors */}
          <div className="space-y-4">
            <h3 className="text-lg font-semibold border-b pb-2">Maintenance & Vendors</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
            ...
            <div>
              <Label htmlFor="wifi_management_vendor">WiFi Management Vendor</Label>
              <Input
                id="wifi_management_vendor"
                value={formData.wifi_management_vendor}
                onChange={(e) => handleInputChange('wifi_management_vendor', e.target.value)}
              />
            </div>
          </div>
          ...
          {/* Utilities & Services */}
          <div className="space-y-4">
            <h3 className="text-lg font-semibold border-b pb-2">Utilities & Services</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
          ...
          {/* Policies & Rules */}
          <div className="space-y-4">
            <h3 className="text-lg font-semibold border-b pb-2">Policies & Rules</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
            ...
            <div>
              <Label htmlFor="guest_policy">Guest Policy</Label>
              <Textarea
                id="guest_policy"
          ...
          {/* Instructions & Notes */}
          <div className="space-y-4">
            <h3 className="text-lg font-semibold border-b pb-2">Instructions & Notes</h3>
            <div>
